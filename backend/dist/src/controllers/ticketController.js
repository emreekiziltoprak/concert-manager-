...
exports.scanTicket = exports.getMyTickets = void 0;
...
const getMyTickets = async (req, res) => {
    const tickets = await ticketService.getUserTicketsWithQrCode((0, requireUser_1.requireUser)(req).userId);
    res.json(tickets);
};
...
const scanTicket = async (req, res) => {
    ...
    if (!ticketId) {
        throw (0, httpError_1.badRequest)(MESSAGES.TICKET.ID_REQUIRED);
    }
