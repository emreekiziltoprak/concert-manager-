...
const specs = swaggerJsdoc(options) as Record<string, any>;

// `export =`, not `export default`: under module: commonjs a default export
// emits `module.exports.default`, and both app.ts and the regression test read
// this module's value directly.
export = specs;
